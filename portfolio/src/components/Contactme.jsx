...
const socialLinks = [
    {
      ...
      //these are the scalable vector graphics to define various shapes and sizes for dev
    ...
    <br />
                ...
                <div className="flex items-center gap-3 mt-auto ">
                    ...
                    (
                        ...
                        ring-inset ring-2 ring-zinc-50 rounded-lg transition-
                        [background-color,color] hover:bg-zinc-50 
                        hover:text-zinc-900 active:bg-zinc50/80"
                        >
                            {icon}
                        </a>
                    ))}
