...
//           {/* Tabs for Selection */}
//           <div className="flex flex-wrap items-center gap-5 md:justify-center sm:justify-center">
...
//                 }}
//                 className={`p-3 font-bold rounded-lg shadow-md transition-all transform 
    ...
    <section id="about" className="section">
      <div className="container">
        ...
        <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12">
          ...
          {/* Animated Content Panel with Fixed Height */}
          <div className="relative overflow-hidden h-[450px] sm:h-[400px] md:h-[310px] lg:h-[200px]"> {/* Set a fixed height */}
            <AnimatePresence mode="wait">
              <motion.div
                key={activeTab}
                initial={{ opacity: 0, y: 20 }}
