...
const Contactme = () => {
  ...
  // Reset the form data when the component is mounted (page load)
  useEffect(() => {
  ...
  return (
    <section id='contact' className='section'>
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        >
          <br /><br />
          <div className="md:grid md:items-center md:grid-cols-2 mg:gap-2 lg:gap-4">
            <div className="mb-">
...
<br />
          ...
          <button
            type='submit'
            className='btn btn-primary1 max-w-full w-full text-zinc-800 text-center'
          >
            Submit
          </button>
        </form>
