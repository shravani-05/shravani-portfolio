...
const socialLinks = [
  {
    ...
    alt: 'GitHub',
    colorClass: 'text-white', // Black for GitHub
  },
  {
    ...
    alt: 'LinkedIn',
    colorClass: 'text-blue-600', // Blue for LinkedIn
  ...
  },
  {
    ...
    alt: 'Twitter X',
    colorClass: 'text-white-400', // Blue for Twitter X
  },
  {
    ...
    alt: 'Instagram',
    colorClass: 'text-pink-500', // Pink for Instagram
  },
];
...
<br /><br />
    ...
    <br />
             ...
             {socialLinks.map(({ href, icon, colorClass, hoverClass}, key) => (
              <a
                key={key}
                href={href}
                target="_blank"
                rel="noopener noreferrer"
                className={`w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50 rounded-lg transition-[background-color,color] ${colorClass} hover:opacity-60`}
              >
                {icon}
              </a>
            ))}
        ...
        <form 
        action="https://getform.io/f/adrrxmxa" 
        method='POST'
        className="xl:pl-10 2xl:pl-20"
        >
          <br /><br />
            <div className="md : grid md: items-center
            md: grid-cols-2 mg:gap-2 lg: gap-4">
                <div className="mb-">
                    <label 
                    htmlFor=""
                    className='label'
            ...
            <div className="grid grid-cols-1">
                ...
                required
                className='text-field resize min-h-20 max-h-48'
                ></textarea>
            </div>
            <br />
            <button
            type='submit'
            className='btn btn-primary1 [&]: max-w-full w-full text-zinc-800 text-center'>Submit</button>
        </form>
        </div>
    </section>
  )
...
//         <div className="mb-12 lg:mb-0 lg:flex lg:flex-col mr-0 ml-auto justify-end">
//           <h2 className="headline-2 lg:max-w-[50ch]">Contact Me</h2>
//           <p className="text-zinc-100 mt-3 mb-8 max-w-[50ch] lg:max-w-[50ch]">
//             Feel free to get in touch with me. I am always open to discussing new technologies, projects, creative ideas,
//             or opportunities to be a part of your vision. Let's contribute together!
//           </p>
//           <div className="flex items-center gap-3 mt-auto">
//             {socialLinks.map(({ href, icon, colorClass }, key) => (
//               <a
//                 key={key}
//                 href={href}
//                 target="_blank"
//                 rel="noopener noreferrer"
//                 className={`w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50 rounded-lg transition-[background-color,color] ${colorClass}`}
//               >
//                 {icon}
//               </a>
//             ))}
//           </div>
//         </div>
//         <form action="https://getform.io/f/adrrxmxa" method="POST" className="xl:pl-10 2xl:pl-20">
//           <br /><br />
//             <div className="md : grid md: items-center
//             md: grid-cols-2 mg:gap-2 lg: gap-4">
//                 <div className="mb-">
